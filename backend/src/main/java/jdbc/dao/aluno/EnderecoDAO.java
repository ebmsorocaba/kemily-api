...
public class EnderecoDAO {
    ...
    public void adiciona(Endereco endereco) throws SQLException {
        PreparedStatement stmt = (PreparedStatement) this.connection.prepareStatement("INSERT INTO endereco (cep, numero, rua, bairro, cidade, ponto_referencia, complemento) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    public void altera(Endereco endereco, String cep, String numero) throws SQLException {
        ...
        PreparedStatement stmt = (PreparedStatement) this.connection.prepareStatement("UPDATE endereco SET rua=?, bairro=?, cidade=?, ponto_referencia=?, complemento=? WHERE cep=? AND numero=?");
