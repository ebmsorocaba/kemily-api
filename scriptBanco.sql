...
CREATE TABLE tb_pagamentos (
  ...
  cpf BIGINT NOT NULL REFERENCES tb_associados(cpf),
  forma_pgto VARCHAR(8) NOT NULL,
  num_cartao BIGINT REFERENCES tb_cartao(numero),
  cod_boleto TEXT,
...
INSERT INTO tb_cartao(numero, bandeira, atual)
 VALUES(4396378924129673, 'Visa', TRUE);
INSERT INTO tb_cartao(numero, bandeira, atual)
 VALUES(5645646545646454, 'MasterCard', TRUE);
INSERT INTO tb_cartao(numero, bandeira, atual)
 VALUES(3132132133213233, 'Discover', TRUE);
INSERT INTO tb_cartao(numero, bandeira, atual)
 VALUES(4564645464611111, 'AmericanExpress', FALSE);

INSERT INTO tb_associados(cpf, nome, celular, email, forma_pgto, num_cartao, valor_atual, venc_atual)
 VALUES(44444444444, 'Godoy Oliveira', 8945666666, 'godoy@gmail.com', 'boleto', 4396378924129673, 10.44, '12/10/15');
INSERT INTO tb_associados(cpf, nome, celular, email, forma_pgto, num_cartao, valor_atual, venc_atual)
 VALUES(55555555555, 'Solange Goes', 4145666666, 'solange@hotmail.com', 'cartao', 5645646545646454, 15.20, '05/10/15');
INSERT INTO tb_associados(cpf, nome, celular, email, forma_pgto, num_cartao, valor_atual, venc_atual)
 VALUES(66666666666, 'Jonathan Nunes', 1145666666, 'jojo@uol.com', 'a vista',3132132133213233, 200.11, '12/10/15');
INSERT INTO tb_associados(cpf, nome, celular, email, forma_pgto, num_cartao, valor_atual, venc_atual)
 VALUES(33333333333, 'Brenda Silva Dias', 1545666666, 'brendadias@gmail.com', 'cartao',4564645464611111, 500.99, '05/10/15');
